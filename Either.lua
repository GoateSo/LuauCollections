...
--[[
creates an Either from the results of a PCall success -> Right(res),failure -> Left(res)
@params
	succ:Boolean
		whether the PCall succeded
	res: String|A
		return of the PCall
@return
	Either[String,A]
...
@params
	f:E=>B
		function to apply to Left
	g:A=>C
		function to apply to Right
@return
	Either[B,C]
		resulting Either
]]
